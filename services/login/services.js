...
.factory('AuthenticationService',
    ...
    function (Base64, $http, $cookieStore, $rootScope, $timeout) {
        ...
        service.Orden = function (direccionEntrega,direccionRecoleccion,callback) {
            $http.post('https://proyectopaquetes.herokuapp.com/orden/registrar'  ,
                {id : $rootScope.globals.currentUser.authdata , direccionEntrega : direccionEntrega , direccionRecoleccion : direccionRecoleccion}).success(function(response,idOrden){
